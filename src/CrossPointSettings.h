...
class CrossPointSettings : public PersistableStore<CrossPointSettings> {
 ...
 public:
  ...
  // Restore the saved on/off state after wake/boot by default. Brightness and
  // warmth are remembered independently. Users can still disable this from
  // Display settings on frontlight boards.
